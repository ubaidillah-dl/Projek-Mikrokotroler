...
void JamDanTanggal() {
  ...
  sprintf(tanggalan, "%s %s %02d %s %02d SUHU %dC", weekDay[now.DayOfWeek()], namaHariPasaran[tanggalJawa.pasaran], now.Day(), monthYear[now.Month()], now.Year(), celsius - koreksisuhu);
